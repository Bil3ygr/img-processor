...
public class Processor implements ActionListener {
	...
	public Processor(Frame frame) {
        ...
        Fr.equalize_hist_color.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
        ...
        if (source == Fr.rotate) {
        	...
        	dft2d = new DFT2D(Fr);
        	dft2d.dft2d_window();
        } else if (source == Fr.filter2d_freq) {
        	filter2d_freq = new Filter2D_Freq(Fr);
        	filter2d_freq.filter2d_freq_window();
        ...
        } else if (source == Fr.equalize_hist_color) {
        	equalize_hist = new Equalize_Hist(Fr);
        	equalize_hist.equalize_hist_window();
